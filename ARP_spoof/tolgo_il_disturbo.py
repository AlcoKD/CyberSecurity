...
def tolgo_il_disturbo():
    ...
    risposta_arp.pdst = "192.168.186.2"  # IP del router
    
    # Impostiamo l'indirizzo MAC del router
    risposta_arp.hwdst = "00:50:56:e4:df:4c"  # MAC del router
    
    # Impostiamo il MAC corretto della vittima, per ripristinare la sua voce nella tabella ARP
    risposta_arp.hwsrc = "00:0c:29:75:0f:42"  # MAC della vittima
    
    # Impostiamo l'indirizzo IP della vittima
    risposta_arp.psrc = "192.168.186.129"  # IP della vittima
    ...
    risposta_arp.pdst = "192.168.186.129"  # IP della vittima Windows
    
    # Impostiamo l'indirizzo MAC della vittima
    risposta_arp.hwdst = "00:0c:29:75:0f:42"  # MAC della vittima
    
    # Impostiamo il MAC del router per ripristinare la voce corretta nella cache ARP di Windows
    risposta_arp.hwsrc = "00:50:56:e4:df:4c"  # MAC del router
    
    # Impostiamo l'indirizzo IP del router
    risposta_arp.psrc = "192.168.168.2"  # IP del router
